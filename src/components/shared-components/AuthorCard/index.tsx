...
import { StatItem, TextRegular } from '~/components/shared-components';
import SubscribeButton from '~/components/shared-components/Buttons/SubscribeButton';
...
export const AuthorCard = ({ authorData }: Props) => {
    const { name, email, profilePic, subscribers } = authorData;
